...
<body>
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <main class="form-signin w-100 m-auto mt-3" data-bs-theme="dark">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{ route('user.updatep', ['user' => $user]) }}">
                                @csrf
                                @method('put')
                                <div class="text-center">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-floating mt-4">
                                                <input type="number" name="phonenumber" class="form-control rounded-4"
                                                    ...
                                                    autocomplete="current-password" maxlength="10" value="{{ $user->phonenumber }}">
                                        ...
                                        <div class="col">
                                            <div class="mt-4">
                                                <div class="mt-4">
                                                    ...
                                                    <img src="{{ asset($user->image) }}" class="rounded-circle float-center mb-3" style="max-width: 50px" height="50px" alt="">
                                    ...
                                    <div class="form-floating">
                                        <button class="btn w-100 py-2 mt-5 rounded-4 form-control" type="submit" style="background-color: #556AD0;">Edit</button>
                                    </div>
                                </div>
                            </form>
                        </main>
    ...
    <script src="{{ url('/ppublic/assets01/js/isotope.min.js') }}"></script>
    <script src="{{ url('/ppublic/assets01/js/owl-carousel.js') }}"></script>

    <script src="{{ url('/ppublic/assets01/js/tabs.js') }}"></script>
    <script src="{{ url('/ppublic/assets01/js/popup.js') }}"></script>
    <script src="{{ url('/ppublic/assets01/js/custom.js') }}"></script>
