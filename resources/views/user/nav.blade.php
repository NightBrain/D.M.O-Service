            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="/user/history"><i class='bx bx-history bx-tada' style='color:#ffffff' ></i> HISTORY</a></li>
                        <li><a href="/user/profile"><i class='bx bxs-user-pin bx-tada' style='color:#ffffff' ></i> PROFILE</a></li>
