        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="/home"><i class='bx bxs-dashboard bx-tada' style='color:#ffffff' ></i> DASHBOARD</a></li>
                        <li><a href="/admin/work"><i class='bx bxs-briefcase bx-tada' style='color:#ffffff' ></i> WORK</a></li>
                        <li><a href="/admin/history"><i class='bx bx-history bx-tada' style='color:#ffffff' ></i> HISTORY</a></li>
                        <li><a href="/admin/profile"><i class='bx bxs-user-pin bx-tada' style='color:#ffffff' ></i> PROFILE</a></li>
                        <li><a href="/admin/password"><i class='bx bxs-cog bx-tada' style='color:#ffffff' ></i> SETTINGS</a></li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf

                            <li><x-dropdown-link :href="route('logout')" style="background-color: #fc7a53;" onclick="event.preventDefault(); this.closest('form').submit();">
                                {{ __('Log Out') }}
                            </x-dropdown-link></li>
                        </form>
                    </ul>
    ...
    <div class="modal-content p-4" style="background-color: #18191bf1; border-radius: 30px;">
        <div class="modal-body">
            <div class="text-end">
                ...
                <img class="rounded mx-auto d-block" src="{{ asset('/public/assets01/images/logolog.png') }}"
